...
describe('REPL', () => {
    ...
    it('speechToTextFilter', () => {
        const allTestCases = [
            ...
            [
                'm&ms 5% 1oz 2#s 3# 4lbs 5lb w/more',
                'm and ms five percent one ounce two pounds three pound four pounds five pound with more',
            ],
            ...
            [
                'okay dr 1/2 1/3 1/4 blt pbj pb pb&j',
                'ok doctor one half one third one quarter b l t p b j p b p b and j',
            ],
        ];
